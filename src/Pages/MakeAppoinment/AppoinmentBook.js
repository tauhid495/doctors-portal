...
const {data:services, isLoading, refetch}= useQuery(['available', formattedDate], ()=> fetch(`https://infinite-everglades-54280.herokuapp.com/available?date=${formattedDate}`)
         .then(res => res.json())
 )
if (isLoading){
